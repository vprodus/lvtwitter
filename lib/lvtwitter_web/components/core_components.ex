defmodule LvtwitterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LvtwitterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LvtwitterWeb.Gettext, "errors", msg, opts)
    end
  end
